...
public class FirstUseActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*if (FirstUseHelper.hasMainHaloFlagInRom())*/
		fragmentPages.add(Pages.HALO_FLAG_CONFLICTING);
		/*if (FirstUseHelper.isAppOnSystem(this))*/
		fragmentPages.add(Pages.APK_ON_SYSTEM);
